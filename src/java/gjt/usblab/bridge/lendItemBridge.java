...
import gjt.usblab.SQLConnection.DatabaseConnection;
...
public class lendItemBridge {
    ...
    public static void consumableUpdatePreborrow(int GetPacketCount, int ConsumableCabinetID) {

        int PbNumber = Server.getInstance().sqlConnection.searchConsumerPreborrowNum(ConsumableCabinetID);
        Server.getInstance().sqlConnection.updatePreborrowConsumer(PbNumber, GetPacketCount);
